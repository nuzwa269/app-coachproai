-- ============================================================
--  CoachPro AI — Atomic review of credit purchases
--  Migration: 009_review_credit_purchase_rpc.sql
--
--  Ensures approve/reject operations remain credit-ledger consistent.
-- ============================================================
...
BEGIN
  ...
  IF p_action = 'approve' THEN
    ...
    SET ai_credits_balance = ai_credits_balance + purchase_row.credits
...
COMMENT ON FUNCTION public.review_credit_purchase IS
  'Atomically approves or rejects a credit purchase with ledger-safe credit updates.';
